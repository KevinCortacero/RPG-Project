...
{   
     ...
     * <I>machine</I>
     * @param numeroVoieDepart numéro de la voie de la station représentée
     ...
     * @throws RemoteException 
     */    
    String nomStationSuivante(final int numeroVoie) throws RemoteException ;
    
    /**
     * Permet de savoir le numéro de la voie suivante se trouvant à l'extrémité de la 
     * voie dont le numéro est passé en paramètre. 
     * Par exemple, lorsqu'une rame se trouve à une extrémité de la ligne, elle
     * change de numéro de voie. Par exemple, la voie suivant la voie 1 est la voie 2.
     * @param numeroVoie numéro de la voie dont on veut connaitre le numéro de la 
     * voie suivante.
     * @return le numéro de la voie suivante
     * @throws RemoteException 
     */     
    int numeroVoieSuivante(final int numeroVoie) throws RemoteException ;

    /**
     * Permet de positionner une rame sur la voie dont le numéro est passé
     * en paramètre.
     * @param numeroVoie numéro de la voie où on veut positionner la rame
     * @param rame rame que l'on veut positionner sur la voie numéro 
     * <I>numeroVoie</I>
     * @throws RemoteException 
     */    
    void setRame (final int numeroVoie, final Rame rame) throws RemoteException ;
     ...
     * @throws RemoteException 
     */
    void allumerFeuxRouge (final int numeroVoie) throws RemoteException ;
